...
def Attrition_rate_finder(request):
    ...
    return render(request, 'attrition_form.html', {'result': results}) #context
...
def Finder(name, location, emp_group, function, gender, tenure_group,
    ...
    if name != "":
        ...
        gen = Gender(gender)
        new_row = {'Experience (YY.MM)': float(experience), 'Age in YY.': float(age), 'New Location': location,
